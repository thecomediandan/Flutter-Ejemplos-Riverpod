...
// * Un ListTile es un Widget tipo button con información
class _CustomListTile extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return ListTile(
      ...
      // * Utilizamos context.push('\alguna_locacion'), para navegar por las rutas de la app gracias al enrutador en el archivo app_router.dart, como GoRoute recibe dos parámetros context y state, pasamos el context para introducir una ruta con push
      // ? onTap: () => GoRouter.of(context).push<String>(location), // Manera mas extensa de navegación.
